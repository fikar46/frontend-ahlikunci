  ...
  return (
   <div className="container mt-5">
        <div className="text-center mb-5">
            <h1>Ahli duplikat dan buka kunci mobil Immobilizer {props.kota != undefined? props.kota:"Zkeys.id"}</h1>
        </div>
        <div className="row">
            ...
            <div className="col-12 col-md-8 col-sm-12 col-xs-12">
               ...
               <h2 className="">Ahli buka dan duplikat kunci Immobilizer<span className="text-utama"> {props.kota != undefined? props.kota:"terdekat"}</span></h2>
