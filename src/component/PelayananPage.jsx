            ...
            <h2 className="text-center text-white py-5">Kami melayani</h2>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        ...
                        <div className="card p-3 pointer" onClick={redirectFunc}>
                            <div className="image-card-pelayanan">
                                <img src="./asset/Car-Keys-Remotes-Replacement-_.webp" className="card-img-top img-card-size" alt=""></img>
                            </div>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card p-3 pointer" onClick={redirectFunc}>
                            <div className="image-card-pelayanan">
                                    <img src="./asset/duplikat.webp" className="card-img-top img-card-size" alt=""></img>
                            </div>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card p-3 pointer" onClick={redirectFunc}>
                            <div className="image-card-pelayanan">
                                    <img src="./asset/new-key.webp" className="card-img-top img-card-size" alt=""></img>
                            </div>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card p-3 pointer" onClick={redirectFunc}>
                            <div className="image-card-pelayanan">
                                    <img src="./asset/immobilizer.webp" className="card-img-top img-card-size" alt=""></img>
                            </div>
                    ...
                    <div className="col-12 col-md-4 mb-4">
                        <div className="card p-3 pointer" onClick={redirectFunc}>
                            <div className="image-card-pelayanan">
                                    <img src="./asset/smartkey.webp" className="card-img-top img-card-size" alt=""></img>
                            </div>
